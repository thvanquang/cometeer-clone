...
const Products = () => {
  ...
  return (
    <div className="mx-auto max-w-[1320px] gap-4 p-6 md:flex">
      <div className="min-w-[50%] md:flex">
        <div className="mx-[-1rem] mb-4 grid grid-cols-6">
        ...
        {/* for mobile screen */}
        <div className="m x-[-1rem] mb-4 grid grid-cols-6 md:hidden">
          <figure className="col-span-full justify-center self-center justify-self-center">
            <img
              src={boxSelected.image}
              alt={boxSelected.title}
        ...
        <div className="mb-6">
          ...
          <div className="max-w-[420px]">
            <div className="mb-2">
              <form action="#">
                <button className="group flex h-full w-full items-center justify-center rounded-full bg-[#f5d577] px-4 py-3 hover:bg-[#ddbf6d]">
                  ...
                  <div className="flex items-center gap-1 text-sm font-semibold">
                    ...
                    <span>$64.00</span>
                    <i className="mx-2 group-hover:animate-transition-right">
                      {arrow}
                    </i>
                  </div>
                </button>
            ...
            <button className="group flex w-full items-center justify-center rounded-full border-[1px] border-black px-4 py-3 text-[#808080] hover:border-0 hover:bg-[#2c2b2b] hover:text-white">
              ...
              <div className="flex items-center gap-2 text-sm font-semibold">
                ...
                <i className="mx-2 text-[#2c2b2b] transition-transform duration-200 ease-out group-hover:animate-transition-right group-hover:text-white">
                  {arrow}
                </i>
              </div>
            </button>
